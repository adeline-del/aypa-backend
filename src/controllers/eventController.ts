...
let inMemoryEvents: IEvent[] = [
  ...
  {
    id: 4,
    title: '75th Biennial Delegates Conference',
    description:
      'The 75th Biennial Delegates Conference marks a significant milestone in the life of the Anglican Young People’s Association, celebrating 75 years of youth service and the contribution of AYPA to the growth and development of the Church.\n\nHeld under the theme “75 Years of Youth Service: The Role of AYPA in Church Development,” the conference brings delegates together for four days of fellowship, reflection, engagement and leadership.\n\nIt provides an opportunity to honour AYPA’s legacy while considering how young Anglicans can continue contributing meaningfully to the present and future mission and development of the Church.\n\nTheme: 75 Years of Youth Service: The Role of AYPA in Church Development\nSpecial Guest of Honour: Rt. Rev’d Dr. Daniel Sylvanus Mensah Torto (Bishop of Accra)\nChairperson: Francis Nii Boye, Esq.\nGuest Speaker: Rev’d Dr. Akua Ofori-Boateng',
    date: '2026-09-17',
    time: '17–20 September 2026',
    location: 'Anglican Retreat Centre, Ashalley Botwe',
    category: 'Leadership',
    capacity: 500,
    registered: 18,
    isLive: false,
